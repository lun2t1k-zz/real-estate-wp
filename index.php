  ...
  <header class="header header--fixed">
    <div class="container">
      <div class="header__inner">
        ...
        <a class="header__phone" href="tel:<?php the_field('main_phone') ?>"><?php the_field('main_phone') ?></a>
                ...
                <div class="cards-item__wrapper">
                  ...
                  <a href="#" class="cards__item">
                    ...
                    <div class="cards__item-info">
                      ...
                      <p class="cards__item-description"><?php get_the_excerpt() ?></p>
                    </div>
                  </a>
                </div>
              </div>
    ...
    <div class="container">
      <div class="footer-wrapper">
        ...
        <div class="footer-contacts">
          <a class="footer__phone" href="tel:<?php the_field('main_phone') ?>"><?php the_field('main_phone') ?></a>
          <a href="mailto:<?php the_field('main_mail') ?>" class="footer__email"><?php the_field('main_mail') ?></a>
        </div>
      </div>
    </div>
  </footer>
